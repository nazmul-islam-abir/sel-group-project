...
class _TeacherProfilePageState extends State<TeacherProfilePage> {
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildChip(Icons.business, teacherInfo['department']?.toString() ?? 'Department'),
              const SizedBox(width: 10),
              _buildChip(Icons.email, teacherInfo['email']?.toString() ?? 'email@university.edu'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildStats() {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          _buildStatCard(Icons.book, teachingCourses.length.toString(), 'Courses', Colors.blue),
          const SizedBox(width: 15),
          _buildStatCard(Icons.people, totalStudents.toString(), 'Students', Colors.green),
          const SizedBox(width: 15),
          _buildStatCard(Icons.folder, teachingCourses.length.toString(), 'Materials', Colors.orange),
        ],
      ),
    );
  }
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 15),
            Text('No Courses Assigned', style: TextStyle(color: Colors.grey.shade600)),
          ],
        ),
      );
    }
        ...
        children: [
          const Row(
            children: [
              ...
              SizedBox(width: 10),
              Text('My Courses', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 15),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(course['name'] ?? 'Course', style: const TextStyle(fontWeight: FontWeight.bold)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          ListTile(
            leading: CircleAvatar(backgroundColor: Colors.green.shade100, child: const Icon(Icons.check_circle, color: Colors.green)),
            title: const Text('Marked attendance for CSE101'),
            subtitle: const Text('2 hours ago'),
          ),
          ListTile(
            leading: CircleAvatar(backgroundColor: Colors.orange.shade100, child: const Icon(Icons.grade, color: Colors.orange)),
